...
class MutationMethods:
    @staticmethod
    def edge_mutation(individual: Individual, probability: float):
    ...
    @staticmethod
    def single_point_mutation(individual: Individual, probability: float):
        for chromosome in individual.chromosomes:
            random_var = random.random()
            if random_var < probability:
    ...
    @staticmethod
    def double_point_mutation(individual: Individual, probability: float):
        for chromosome in individual.chromosomes:
